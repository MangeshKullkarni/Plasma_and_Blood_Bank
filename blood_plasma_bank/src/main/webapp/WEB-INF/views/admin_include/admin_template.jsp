      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="layout">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#layout" data-parent="#exampleAccordion">
            ...
            <li>
              <a href="<spring:url value='/admin/blood_request'/>"><i class="fa fa-fw fa-link"></i>Request's</a>
            </li>
              <li>  
              <a href="<spring:url value='/admin/add_doner'/>"> <i class="fa fa-fw fa-link"></i>  Camp Blood Donner's </a>
            </li>
            <li>
              <a href="<spring:url value='/admin/hospital_request'/>"><i class="fa fa-fw fa-link"></i>Request From Hospital</a>
            </li>
         ...
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="vendor">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#vendor" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Hospital's</span>
          </a>
            <ul class="sidenav-second-level collapse" id="vendor">
            <li>  
              <a href="<spring:url value='/admin/show_hospitals'/>">  <i class="fa fa-fw fa-file"></i> Hospital Details</a>
            </li>
            <li>
              <a href="<spring:url value='/admin/hospital_registration'/>"><i class="fa fa-fw fa-file"></i>Hospital Registration</a>
            </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="<spring:url value='/admin/add_stocks'/>">Add Stocks</a>
            </li>
             <li>
              <a href="<spring:url value='/admin/release_stocks'/>">Release Stocks</a>
            </li>
           
            <li>
              <a href="<spring:url value='/admin/camp_details'/>">Blood Camp Details</a>
            </li>
            <li>
              <a href="<spring:url value='/admin/arrange_camp'/>">Arrange Camp's</a>
            </li>
