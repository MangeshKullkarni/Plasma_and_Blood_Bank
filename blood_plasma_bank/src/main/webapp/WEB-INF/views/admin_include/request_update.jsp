	...
	<div class="container-fluid">
		...
		<div class="container mt-3">
			<div class="container" style="margin-top: 50px;">
				<form method="post">
					<fieldset>
					<input type="hidden" name="rid" value="${RequestDetails.id}"/>
						<div class="row form-group">
							<label style="font-size: 25px; margin: 2px" class="col-lg-4 control-label" for="hospitalName">Hospital Name  </label>
							<div class="col-lg-4">
								<div class="input-group">
									<input name="hospitalName" id="hospitalName" class="form-control" type="text" value="${RequestDetails.hospitalName}" readonly="true" />
								</div>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-lg-12">
								...
								<input type="text" name="type" value="Fluid type : ${RequestDetails.type}" class="form-control text-center" readonly="true">
							</div>
						</div>

						<div class="row form-group">
							<div class="col-lg-12">
								<input type="text" name="type" value="Blood Group: ${RequestDetails.group}" class="form-control text-center" readonly="true">
							</div>
						</div>
						<div class="row form-group">
							...
							<div class="col-lg-4">
								<div class="input-group">
									<input name="quantity" id="quantity" class="form-control" type="number" value="${RequestDetails.quantity}"/>
								</div>
							</div>
						</div>
