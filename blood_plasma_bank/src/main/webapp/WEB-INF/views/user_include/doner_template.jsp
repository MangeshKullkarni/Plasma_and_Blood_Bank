			...
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					data-parent="#exampleAccordion"> <i class="fa fa-fw fa-sitemap"></i>
						<span class="nav-link-text">Blood Camp</span>
				</a>
					<ul class="sidenav-second-level collapse" id="layout">
						<li><a href="<spring:url value='/user/upcommingCamp'/>">
								<i class="fa fa-fw fa-link"></i> Upcomming Camp
						</a></li>
						<li><a href="<spring:url value='/user/attendedCamp'/>"><i
								class="fa fa-fw fa-link"></i>Attended Camp</a></li>
					</ul></li>
			</ul>
